...
class SelectorError(AgentBaseException):
    ...
    def __init__(self, message: str, selector: str | None = None, **kwargs):
        """
...
class LoopDetectedError(AgentBaseException):
    ...
    def __init__(
        self, message: str, loop_count: int = 0, repeated_actions: list | None = None, **kwargs
    ):
        """
        ...
        """
        context = kwargs.get("context", {})
        context.update({"loop_count": loop_count, "repeated_actions": repeated_actions or []})
        super().__init__(message, context=context, **kwargs)
...
class LLMError(AgentBaseException):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        context = kwargs.get("context", {})
        context.update({"model_name": model_name, "prompt_tokens": prompt_tokens})
        super().__init__(message, context=context, **kwargs)
...
class CaptchaDetectedError(AgentBaseException):
    ...
    def __init__(self, message: str, page_url: str | None = None, **kwargs):
        """
